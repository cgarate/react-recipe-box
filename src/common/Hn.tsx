...
const Header1: React.FunctionComponent<Props & StyledSystemProps> = ({
  className,
  children,
}) => {
...
const Header2: React.FunctionComponent<Props & StyledSystemProps> = ({
  className,
  children,
}) => {
...
const Header3: React.FunctionComponent<Props & StyledSystemProps> = ({
  className,
  children,
}) => {
...
const Header4: React.FunctionComponent<Props & StyledSystemProps> = ({
  className,
  children,
}) => {
...
const Header5: React.FunctionComponent<Props & StyledSystemProps> = ({
  className,
  children,
}) => {
...
const Header6: React.FunctionComponent<Props & StyledSystemProps> = ({
  className,
  children,
}) => {
